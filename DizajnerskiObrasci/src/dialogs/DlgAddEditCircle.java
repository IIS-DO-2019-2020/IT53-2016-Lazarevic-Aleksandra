...
public class DlgAddEditCircle extends JDialog {
	...
	public void addCircle(int x,int y,Color out,Color in)
	{
	...
	public void editCircle(int x,int y,int r,Color out,Color in)
	{
